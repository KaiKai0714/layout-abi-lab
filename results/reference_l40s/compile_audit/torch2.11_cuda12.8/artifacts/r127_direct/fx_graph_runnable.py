...
os.environ['TORCHINDUCTOR_CACHE_DIR'] = '<AUDIT_CACHE>/r127_direct/inductor'
os.environ['TRITON_CACHE_DIR'] = '<AUDIT_CACHE>/r127_direct/triton'
...
torch._dynamo.config.debug_dir_root = '<REPO>/results/local_l40s_compile_three_level_audit/artifacts/r127_direct/debug_tmp/torch_compile_debug'
...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1):
        ...
        expand = torch.ops.aten.expand.default(clamp_min, [1, 64, 127, 127]);  clamp_min = None
        ...
        view = torch.ops.aten.view.default(getitem, [1, 4, 32, 16129]);  getitem = None
        view_1 = torch.ops.aten.view.default(getitem_1, [1, 4, 32, 16129]);  getitem_1 = None
        view_2 = torch.ops.aten.view.default(getitem_2, [1, 4, 32, 16129]);  getitem_2 = None
        ...
        expand_3 = torch.ops.aten.expand.default(convert_element_type_5, [1, 4, 32, 16133]);  convert_element_type_5 = None
        view_3 = torch.ops.aten.view.default(expand_3, [4, 32, 16133]);  expand_3 = None
        expand_4 = torch.ops.aten.expand.default(permute, [1, 4, 16133, 32]);  permute = None
        view_4 = torch.ops.aten.view.default(expand_4, [4, 16133, 32]);  expand_4 = None
        ...
        expand_6 = torch.ops.aten.expand.default(mul_2, [1, 4, 32, 16129]);  mul_2 = None
        view_7 = torch.ops.aten.view.default(expand_6, [4, 32, 16129]);  expand_6 = None
        bmm_1 = torch.ops.aten.bmm.default(view_6, view_7);  view_6 = view_7 = None
        view_8 = torch.ops.aten.view.default(bmm_1, [1, 4, 32, 16129]);  bmm_1 = None
        view_9 = torch.ops.aten.view.default(view_8, [1, 128, 127, 127]);  view_8 = None
        ...
        expand_7 = torch.ops.aten.expand.default(clamp_min_1, [1, 64, 127, 127]);  clamp_min_1 = None
...
def load_args(reader):
    buf0 = reader.storage(None, 2064512, device=device(type='cuda', index=0), dtype_hint=torch.float16)
    reader.tensor(buf0, (1, 64, 127, 127), dtype=torch.float16, is_leaf=True)  # arg0_1
