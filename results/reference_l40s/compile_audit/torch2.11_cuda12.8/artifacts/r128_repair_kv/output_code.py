...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/5q/c5qee6uttgqyufifua5diz2ws2ukczg4szo44b6w3nrbdmnd72cp.py
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/66/c66lyuvianmacvv264lq5d2orxaqqtevsco57hqo46lsyv4twnwr.py
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/wd/cwddkeku6755fg5unhxykhihvmdo5unmfydhvqjlqovr64t62kqu.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/me/cmehtgoozhu3s24iaiet6f334bw7ybehpcranllkqwtmnwrvrk2t.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/qt/cqtivynshj65wntqx7ogqtzsl4a4qb7r2nddjwyfdggzn5z37c5g.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/ys/cysraag227uij5fnvfydlmyk4qkf6s54loeta7mihkyvkeo2gg25.py
...
#   %permute : Tensor "f16[1, 4, 16388, 32][2097664, 524416, 1, 16388]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_5, [0, 1, 3, 2]), kwargs = {})
#   %clone : Tensor "f16[1, 4, 16388, 32][2097664, 524416, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/2j/c2j2hlkmgf7grbv4rpm6s4juf7vy43dw7l5mwyrsqeebpm7ikkzk.py
...
#   %permute_2 : Tensor "f16[1, 4, 16388, 32][2097664, 524416, 1, 16388]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%cat_1, [0, 1, 3, 2]), kwargs = {})
#   %clone_1 : Tensor "f16[1, 4, 16388, 32][2097664, 524416, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_2,), kwargs = {memory_format: torch.contiguous_format})
#   return %expand_4
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/xm/cxm6mcszydxp6k2jquhouuc3yo7whfxdutgl2et34zjreugzd7ol.py
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/3h/c3hse2mka6n25t4oyda37m73uuq2zfg6u77loczfd5pdpxb6f2ac.py
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/tc/ctc7q76iwajgqjkwrjly6wnqm552l6t4ge7w6fy5evpozrs2sew2.py
...
# kernel path: <AUDIT_CACHE>/r128_repair_kv/inductor/tj/ctj4xf4xit47zya3bb6fupliwvpmglltudxlt634vjch4jrzcgsh.py
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf5
        buf7 = empty_strided_cuda((1, 4, 16388, 32), (2097664, 524416, 32, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, , transpose, contiguous], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, aten.sub, aten.exp, aten.transpose, aten.clone]
        # [Provenance debug handles] triton_poi_fused__softmax_cat_clone_exp_expand_select_split_sub_transpose_unsqueeze_view_5:7
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_cat_clone_exp_expand_select_split_sub_transpose_unsqueeze_view_5.run(arg3_1, buf2, buf4, buf6, buf7, 2097664, stream=stream0)
        del buf4
        del buf6
        buf8 = empty_strided_cuda((1, 4, 16388, 32), (2097664, 524416, 32, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_4, unsqueeze_1, memory_v, v_1, v_2, transpose_2, contiguous_1], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten.transpose, aten.clone]
        # [Provenance debug handles] triton_poi_fused_cat_clone_expand_select_split_transpose_unsqueeze_view_6:8
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_clone_expand_select_split_transpose_unsqueeze_view_6.run(arg3_1, buf2, buf8, 2097664, stream=stream0)
        del arg3_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf7, (4, 32, 16388), (524416, 1, 32), 0), reinterpret_tensor(buf8, (4, 16388, 32), (524416, 32, 1), 0), out=buf9)
        del buf7
        del buf8
