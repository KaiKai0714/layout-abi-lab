...
os.environ['TORCHINDUCTOR_CACHE_DIR'] = '<AUDIT_CACHE>/r255_repair_kv/inductor'
os.environ['TRITON_CACHE_DIR'] = '<AUDIT_CACHE>/r255_repair_kv/triton'
...
torch._dynamo.config.debug_dir_root = '<REPO>/results/local_l40s_compile_three_level_audit/artifacts/r255_repair_kv/debug_tmp/torch_compile_debug'
...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1):
        ...
        expand_3 = torch.ops.aten.expand.default(permute_1, [1, 4, 32, 65029]);  permute_1 = None
        view_3 = torch.ops.aten.view.default(expand_3, [4, 32, 65029]);  expand_3 = None
        expand_4 = torch.ops.aten.expand.default(clone_1, [1, 4, 65029, 32]);  clone_1 = None
