...
os.environ['TORCHINDUCTOR_CACHE_DIR'] = '<AUDIT_CACHE>/r126_direct/inductor'
os.environ['TRITON_CACHE_DIR'] = '<AUDIT_CACHE>/r126_direct/triton'
...
torch._dynamo.config.debug_dir_root = '<REPO>/results/local_l40s_compile_three_level_audit/artifacts/r126_direct/debug_tmp/torch_compile_debug'
...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1):
        ...
        expand_3 = torch.ops.aten.expand.default(convert_element_type_5, [1, 4, 32, 15880]);  convert_element_type_5 = None
        view_3 = torch.ops.aten.view.default(expand_3, [4, 32, 15880]);  expand_3 = None
        expand_4 = torch.ops.aten.expand.default(permute, [1, 4, 15880, 32]);  permute = None
