...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/mr/cmr4yywz6glhezxjets2d4afjmawbcz7o676a27obp3x4iagwqfy.py
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/ro/crodiiwfg2f65l2dggevthygtaowti3ew762doo5vidpcsjypz7f.py
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/pq/cpqhw7jwykcsml7vkdbpewfr4l4zolmehr6stbrusxsgzkmnjhhx.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/5q/c5qulg6uzv2u45rgm4zdwhjlbdhdzj4ecjlcekuddj7mtbxszdfk.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/fb/cfb5szwsjvbhkbpeoqst6au7kfbc3oyizha764beukr2ebgkvsk3.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/hb/chbqyeelt7yff6geq5gki6e47lfwbtskq3kz46lh3xnzgbkigr2y.py
...
def triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 >= tmp3
    tmp7 = tl.full([1, 1], 15880, tl.int64)
    tmp8 = tmp0 < tmp7
    ...
    tl.store(out_ptr0 + (x1 + 15880*y0), tmp17, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r126_direct/inductor/rg/crgdjvwnsxa34hducc46doba26yvwhn2a5sbed3gkgkjagmxalg4.py
...
def triton_poi_fused_cat_expand_select_split_unsqueeze_view_6(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp10 = tl.where(tmp4, tmp5, tmp9)
    tl.store(out_ptr0 + (x1 + 15880*y0), tmp10, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r126_direct/inductor/mc/cmcod6w5ug4lip5nvat4f3jcrpzjbkziqhjtusukgzavrvuhkjgl.py
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/my/cmyhb7337xrnmxqonuhcimqvqpu4gqprielgezzqpz7zjxsr3ap2.py
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/tj/ctjzjp3s3w7wv2r4omtlka3hislylspulpr7mzh4nghzjsv46dts.py
...
# kernel path: <AUDIT_CACHE>/r126_direct/inductor/fs/cfs6phenln4quok75no6axvt5s3tcntw2xsujk6ta52m363iv62l.py
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf5
        buf7 = empty_strided_cuda((1, 4, 32, 15880), (2032640, 508160, 15880, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, aten.sub, aten.exp]
        # [Provenance debug handles] triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5:7
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5.run(arg3_1, buf2, buf4, buf6, buf7, 128, 15880, stream=stream0)
        del buf4
        del buf6
        buf8 = empty_strided_cuda((1, 4, 32, 15880), (2032640, 508160, 15880, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_4, unsqueeze_1, memory_v, v_1, v_2], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat]
        # [Provenance debug handles] triton_poi_fused_cat_expand_select_split_unsqueeze_view_6:8
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_expand_select_split_unsqueeze_view_6.run(arg3_1, buf2, buf8, 128, 15880, stream=stream0)
        del arg3_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf7, (4, 32, 15880), (508160, 15880, 1), 0), reinterpret_tensor(buf8, (4, 15880, 32), (508160, 1, 15880), 0), out=buf9)
        del buf7
        del buf8
