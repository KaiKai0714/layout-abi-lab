...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/el/celwq2cj3apfba5ka3ka52rjqshsj7cixkq3gllygjgwiddcjsnp.py
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/pi/cpismskedg3b5vc3wx3hjq2rkl5igw2pr5njiow2v7bqhifniueh.py
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/yl/cyl6pfu5xd6cnmxjrhdkwczjdjt2ua3qihakzsicatz43fr6hdyn.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/3l/c3lrabzaux3seh3inrajljae24goisqwtd53fkszxlz6rm4netps.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/hu/chumgdnsud4eb2eqvqmpe44wi5gtvrm3g5qtoj3f6cjfms7wyjmm.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/ys/cyscpfddv5jps6c7hvazqbegpb4ithii5wlbztumveptbyvkzfzz.py
...
@triton_heuristics.pointwise(
    size_hints={'y': 128, 'x': 131072}, tile_hint=TileHint.DEFAULT,
    filename=__file__,
...
def triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 >= tmp3
    tmp7 = tl.full([1, 1], 65540, tl.int64)
    tmp8 = tmp0 < tmp7
    ...
    tl.store(out_ptr0 + (x1 + 65540*y0), tmp17, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r256_direct/inductor/t4/ct4tm4xje52ie4etyrsanrswy3etdleojybwu46nkimpagl3mo6v.py
...
def triton_poi_fused_cat_expand_select_split_unsqueeze_view_6(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp10 = tl.where(tmp4, tmp5, tmp9)
    tl.store(out_ptr0 + (x1 + 65540*y0), tmp10, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r256_direct/inductor/to/ctoci5mnlot24yurdnf2jk7qzyz7agnb5ym6v2hsih5vgevm7qhh.py
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/pg/cpgmxxkp4um5dx5xigiuoefylkwqe2bvuwpcxs2ovrix6ijb4ex4.py
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/cj/ccjtkwwtn5rg6wgm3daiirfdsw3llkp2oonhabrf7msaid5dphm6.py
...
# kernel path: <AUDIT_CACHE>/r256_direct/inductor/ol/colyms5y6xlkidqcuipotd6lijvuy7ljmec7n5gl23c6wvvdpy25.py
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf5
        buf7 = empty_strided_cuda((1, 4, 32, 65540), (8389120, 2097280, 65540, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, aten.sub, aten.exp]
        # [Provenance debug handles] triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5:7
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5.run(arg3_1, buf2, buf4, buf6, buf7, 128, 65540, stream=stream0)
        del buf4
        del buf6
        buf8 = empty_strided_cuda((1, 4, 32, 65540), (8389120, 2097280, 65540, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_4, unsqueeze_1, memory_v, v_1, v_2], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat]
        # [Provenance debug handles] triton_poi_fused_cat_expand_select_split_unsqueeze_view_6:8
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_expand_select_split_unsqueeze_view_6.run(arg3_1, buf2, buf8, 128, 65540, stream=stream0)
        del arg3_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf7, (4, 32, 65540), (2097280, 65540, 1), 0), reinterpret_tensor(buf8, (4, 65540, 32), (2097280, 1, 65540), 0), out=buf9)
        del buf7
        del buf8
