...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/yv/cyvpytm4bouurysyqcp5j5ulzwctm7ztuyaqb7drorxeyncjcwdl.py
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/sr/csrvrf2twjkzmhk4wfc3vbhzjyu77t5j7qmsqlq2lmondvae2sgo.py
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/jv/cjvywy5nescsaxibvv5amcukq66bwky3rselqrimtg4jx6xwnzbw.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/se/cseai72im2jgdylcqonxzs6qi2bxks2s5fbmvjjgwjopjnvuzewg.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/wg/cwgugrle7jawv3rv5xk7euyunv4g3kafgx5xyw7whv7hk7cfxkiw.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/av/cavadab5hzg6xcvtbmqyk7wm2kezranvnyegbcurdlbjeb5tidn7.py
...
#   %view_3 : Tensor "f16[4, 32, 65029][2080928, 65029, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%expand_3, [4, 32, 65029]), kwargs = {})
#   %constant_pad_nd_default : Tensor "f16[4, 32, 65032][2081024, 65032, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_3, [0, 3, 0, 0, 0, 0]), kwargs = {})
...
@triton_heuristics.pointwise(
    size_hints={'y': 128, 'x': 65536}, tile_hint=TileHint.DEFAULT,
    filename=__file__,
...
def triton_poi_fused__softmax_bmm_cat_exp_expand_select_split_sub_unsqueeze_view_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y0 = yindex
    tmp0 = x1
    tmp1 = tl.full([1, 1], 65029, tl.int64)
    tmp2 = tmp0 < tmp1
    ...
    tmp10 = tmp3 >= tmp6
    tmp11 = tl.full([1, 1], 65029, tl.int64)
    tmp12 = tmp3 < tmp11
    tmp13 = tmp10 & tmp2
    ...
    tl.store(out_ptr0 + (x1 + 65088*y0), tmp24, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r255_direct/inductor/sx/csxaal227esf4f5hu6zvqjv3yqvadhhndk33rkvfwkynqvx5lphh.py
...
#   %permute : Tensor "f16[1, 4, 65029, 32][8323712, 2080928, 1, 65029]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%cat_1, [0, 1, 3, 2]), kwargs = {})
#   %view_4 : Tensor "f16[4, 65029, 32][2080928, 1, 65029]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%expand_4, [4, 65029, 32]), kwargs = {})
#   %constant_pad_nd_default_1 : Tensor "f16[4, 65032, 32][2081024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_4, [0, 0, 0, 3, 0, 0]), kwargs = {})
...
def triton_poi_fused_bmm_cat_expand_select_split_transpose_unsqueeze_view_6(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp10 = tmp3 >= tmp6
    tmp11 = tl.full([1], 65029, tl.int64)
    tmp12 = tmp3 < tmp11
    tmp13 = tmp10 & tmp2
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/cn/ccnmix7yqirpzxwjqgxuwveznd4xh3lkryrqcjzfnhylw7fx6wlb.py
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/tk/ctkrpvhtt3km3l2kphe3i2cctfakpqcffuv3sbvrb5awyytjoskm.py
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/47/c47jjx34kygyb4onlfnzdy2rbgiaan2iu3i3ouptp5lbkethqi2h.py
...
# kernel path: <AUDIT_CACHE>/r255_direct/inductor/xe/cxea2fpsjtfh5h3qopfbgwksg33oongty7n7coiioimhnnwhrjwn.py
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf5
        buf7 = empty_strided_cuda((4, 32, 65032), (2082816, 65088, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, , context], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, aten.sub, aten.exp, aten.bmm]
        # [Provenance debug handles] triton_poi_fused__softmax_bmm_cat_exp_expand_select_split_sub_unsqueeze_view_5:7
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_bmm_cat_exp_expand_select_split_sub_unsqueeze_view_5.run(arg3_1, buf2, buf4, buf6, buf7, 128, 65032, stream=stream0)
        del buf4
        del buf6
        buf8 = empty_strided_cuda((4, 65032, 32), (2081024, 32, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_4, unsqueeze_1, memory_v, v_1, v_2, transpose, context, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten.transpose, aten.bmm]
        # [Provenance debug handles] triton_poi_fused_bmm_cat_expand_select_split_transpose_unsqueeze_view_6:8
        stream0 = get_raw_stream(0)
        triton_poi_fused_bmm_cat_expand_select_split_transpose_unsqueeze_view_6.run(arg3_1, buf2, buf8, 8324096, stream=stream0)
        del arg3_1
