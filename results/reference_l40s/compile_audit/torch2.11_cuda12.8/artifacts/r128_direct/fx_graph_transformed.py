class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[1, 64, 128, 128]", arg1_1: "f16[1, 64, 1, 1]", arg2_1: "f16[384, 64, 1, 1]", arg3_1: "f16[2, 4, 32, 4]", arg4_1: "f16[64, 128, 1, 1]", arg5_1: "f16[64]", arg6_1: "f16[1, 64, 1, 1]"):
        ...
        expand_3: "f16[1, 4, 32, 16388]" = torch.ops.aten.expand.default(convert_element_type_5, [1, 4, 32, 16388]);  convert_element_type_5 = None
        ...
        # File: <REPO>/layoutabi/workload.py:38 in context_from_kv, code: return k @ v.transpose(-2, -1)
        permute: "f16[1, 4, 16388, 32]" = torch.ops.aten.permute.default(cat_1, [0, 1, 3, 2]);  cat_1 = None
        expand_4: "f16[1, 4, 16388, 32]" = torch.ops.aten.expand.default(permute, [1, 4, 16388, 32]);  permute = None
