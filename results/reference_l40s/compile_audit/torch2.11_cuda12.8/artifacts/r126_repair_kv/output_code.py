...
# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/mr/cmr4yywz6glhezxjets2d4afjmawbcz7o676a27obp3x4iagwqfy.py
...
# Graph fragment:
#   %arg0_1 : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0" = PlaceHolder[target=arg0_1]
#   %sum_1 : Tensor "f32[1, 1, 126, 126][15904, 15904, 126, 1]cuda:0" = PlaceHolder[target=sum_1]
#   %arg1_1 : Tensor "f16[1, 64, 1, 1][64, 1, 1, 1]cuda:0" = PlaceHolder[target=arg1_1]
#   %convert_element_type : Tensor "f32[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type, 2.0), kwargs = {})
#   %sum_1 : Tensor "f32[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%pow_1, [1], True), kwargs = {})
#   %pow_2 : Tensor "f32[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_1, 0.5), kwargs = {})
#   %convert_element_type_1 : Tensor "f16[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_2, torch.float16), kwargs = {})
#   %clamp_min : Tensor "f16[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%convert_element_type_1, 1e-12), kwargs = {})
#   %expand : Tensor "f16[1, 64, 126, 126][15876, 0, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%clamp_min, [1, 64, 126, 126]), kwargs = {})
#   %div : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%arg0_1, %expand), kwargs = {})
#   %mul : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %arg1_1), kwargs = {})
#   %mul_1 : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul, 8.0), kwargs = {})
#   return %sum_1,%mul_1
...
def triton_per_fused_clamp_min_div_expand_linalg_vector_norm_mul_0(in_ptr0, in_ptr1, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    r0_1 = r0_index
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 15876*r0_1), xmask, other=0.0).to(tl.float32)
...
# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/ro/crodiiwfg2f65l2dggevthygtaowti3ew762doo5vidpcsjypz7f.py
...
#   %convolution : Tensor "f16[1, 384, 126, 126][6096384, 1, 48384, 384]cuda:0" = PlaceHolder[target=convolution]
...
#   %view_1 : Tensor "f16[1, 4, 32, 15876][6096384, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%getitem_1, [1, 4, 32, 15876]), kwargs = {})
#   %cat : Tensor "f16[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%expand_1, %view_1], -1), kwargs = {})
#   %convert_element_type_4 : Tensor "f32[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%cat, torch.float32), kwargs = {})
...
def triton_red_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_1(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, r0_numel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
        ...
        r0_2 = r0_index
        tmp0 = r0_2 + 128*x1
        tmp1 = tl.full([1, 1, 1], 15880, tl.int32)
        tmp2 = tmp0 < tmp1
        ...
        tmp10 = tmp3 >= tmp6
        tmp11 = tl.full([1, 1, 1], 15880, tl.int64)
        tmp12 = tmp3 < tmp11
        tmp13 = tmp10 & tmp2
    ...
    tl.store(out_ptr0 + (x1 + 125*y0), tmp20, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/pq/cpqhw7jwykcsml7vkdbpewfr4l4zolmehr6stbrusxsgzkmnjhhx.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
#   unsqueeze => unsqueeze
# Graph fragment:
#   %buf3 : Tensor "f32[1, 4, 32, 1, 125][16000, 4000, 125, 16000, 1]cuda:0" = PlaceHolder[target=buf3]
#   %split : [num_users=3] = call_function[target=torch.ops.aten.split.Tensor](args = (%convolution, 128, 1), kwargs = {})
#   %select : Tensor "f16[4, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg3_1, 0, 0), kwargs = {})
#   %unsqueeze : Tensor "f16[1, 4, 32, 4][512, 128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select, 0), kwargs = {})
#   %expand_1 : Tensor "f16[1, 4, 32, 4][512, 128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze, [1, -1, -1, -1]), kwargs = {})
...
# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/5q/c5qulg6uzv2u45rgm4zdwhjlbdhdzj4ecjlcekuddj7mtbxszdfk.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
def triton_red_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_3(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, r0_numel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x1 + 125*y0), tmp23, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/fb/cfb5szwsjvbhkbpeoqst6au7kfbc3oyizha764beukr2ebgkvsk3.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
#   unsqueeze => unsqueeze
# Graph fragment:
#   %buf5 : Tensor "f32[1, 4, 32, 1, 125][16000, 4000, 125, 16000, 1]cuda:0" = PlaceHolder[target=buf5]
#   %split : [num_users=3] = call_function[target=torch.ops.aten.split.Tensor](args = (%convolution, 128, 1), kwargs = {})
#   %select : Tensor "f16[4, 32, 4][128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg3_1, 0, 0), kwargs = {})
#   %unsqueeze : Tensor "f16[1, 4, 32, 4][512, 128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select, 0), kwargs = {})
#   %expand_1 : Tensor "f16[1, 4, 32, 4][512, 128, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze, [1, -1, -1, -1]), kwargs = {})
...
# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/x4/cx42t3jvped5xwytoertaamwnunoduunbgsc3bmb2kbsdyudz7wk.py
...
#   %cat : Tensor "f16[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%expand_1, %view_1], -1), kwargs = {})
#   %convert_element_type_4 : Tensor "f32[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%cat, torch.float32), kwargs = {})
#   %sub_tensor_1 : Tensor "f32[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_4, %getitem_5), kwargs = {})
#   %exp_default_1 : Tensor "f32[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%sub_tensor_1,), kwargs = {})
#   %div_2 : Tensor "f32[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%exp_default_1, %getitem_6), kwargs = {})
#   %convert_element_type_5 : Tensor "f16[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div_2, torch.float16), kwargs = {})
#   %permute : Tensor "f16[1, 4, 15880, 32][2032640, 508160, 1, 15880]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_5, [0, 1, 3, 2]), kwargs = {})
#   %clone : Tensor "f16[1, 4, 15880, 32][2032640, 508160, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone
...
# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/7i/c7inmvgvivv7szcjnst56xgs7b6u5c5qcbglkbtcvdu4fo7fpnxf.py
...
#   %view_2 : Tensor "f16[1, 4, 32, 15876][6096384, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%getitem_2, [1, 4, 32, 15876]), kwargs = {})
#   %cat_1 : Tensor "f16[1, 4, 32, 15880][2032640, 508160, 15880, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%expand_2, %view_2], -1), kwargs = {})
#   %permute_2 : Tensor "f16[1, 4, 15880, 32][2032640, 508160, 1, 15880]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%cat_1, [0, 1, 3, 2]), kwargs = {})
#   %clone_1 : Tensor "f16[1, 4, 15880, 32][2032640, 508160, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_2,), kwargs = {memory_format: torch.contiguous_format})
#   return %expand_4
...
# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/mc/cmcod6w5ug4lip5nvat4f3jcrpzjbkziqhjtusukgzavrvuhkjgl.py
...
#   %convolution : Tensor "f16[1, 384, 126, 126][6096384, 1, 48384, 384]cuda:0" = PlaceHolder[target=convolution]
#   %split : [num_users=3] = call_function[target=torch.ops.aten.split.Tensor](args = (%convolution, 128, 1), kwargs = {})
#   %view : Tensor "f16[1, 4, 32, 15876][6096384, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%getitem, [1, 4, 32, 15876]), kwargs = {})
#   %convert_element_type_2 : Tensor "f32[1, 4, 32, 15876][6096384, 508032, 15876, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view, torch.float32), kwargs = {})
...
# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/my/cmyhb7337xrnmxqonuhcimqvqpu4gqprielgezzqpz7zjxsr3ap2.py
...
# Graph fragment:
#   %convolution : Tensor "f16[1, 384, 126, 126][6096384, 1, 48384, 384]cuda:0" = PlaceHolder[target=convolution]
#   %getitem_3 : Tensor "f32[1, 4, 1, 15876][63504, 1, 63504, 4]cuda:0" = PlaceHolder[target=getitem_3]
#   %getitem_4 : Tensor "f32[1, 4, 1, 15876][63504, 1, 63504, 4]cuda:0" = PlaceHolder[target=getitem_4]
#   %split : [num_users=3] = call_function[target=torch.ops.aten.split.Tensor](args = (%convolution, 128, 1), kwargs = {})
#   %view : Tensor "f16[1, 4, 32, 15876][6096384, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%getitem, [1, 4, 32, 15876]), kwargs = {})
#   %convert_element_type_2 : Tensor "f32[1, 4, 32, 15876][6096384, 508032, 15876, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view, torch.float32), kwargs = {})
#   %sub_tensor : Tensor "f32[1, 4, 32, 15876][2032128, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_2, %getitem_3), kwargs = {})
#   %exp_default : Tensor "f32[1, 4, 32, 15876][2032128, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%sub_tensor,), kwargs = {})
#   %div_1 : Tensor "f32[1, 4, 32, 15876][2032128, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%exp_default, %getitem_4), kwargs = {})
#   %convert_element_type_3 : Tensor "f16[1, 4, 32, 15876][2032128, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div_1, torch.float16), kwargs = {})
#   %mul_2 : Tensor "f16[1, 4, 32, 15876][2032128, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_3, 0.1767766952966369), kwargs = {})
#   return %expand_6
...
def triton_poi_fused__softmax_exp_mul_split_sub_view_8(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp9 = tmp7 * tmp8
    tl.store(out_ptr0 + (y0 + 15876*x3), tmp9, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/tj/ctjzjp3s3w7wv2r4omtlka3hislylspulpr7mzh4nghzjsv46dts.py
...
#   out_1 => view_9
# Graph fragment:
#   %bmm_1 : Tensor "f16[4, 32, 15876][508032, 15876, 1]cuda:0" = PlaceHolder[target=bmm_1]
#   %view_8 : Tensor "f16[1, 4, 32, 15876][2032128, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_1, [1, 4, 32, 15876]), kwargs = {})
#   %view_9 : Tensor "f16[1, 128, 126, 126][2032128, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_8, [1, 128, 126, 126]), kwargs = {})
#   %convolution_1 : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.convolution.default](args = (%view_9, %arg4_1, %arg5_1, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   return %buf14
...
def triton_poi_fused_convolution_view_9(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    x1 = xindex
    y0 = yindex
    tmp0 = tl.load(in_ptr0 + (x1 + 15876*y0), xmask & ymask, eviction_policy='evict_last').to(tl.float32)
    tl.store(out_ptr0 + (y0 + 128*x1), tmp0, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r126_repair_kv/inductor/fs/cfs6phenln4quok75no6axvt5s3tcntw2xsujk6ta52m363iv62l.py
...
#   out_1 => view_9
# Graph fragment:
#   %buf15 : Tensor "f16[1, 64, 126, 126][1016064, 1, 8064, 64]cuda:0" = PlaceHolder[target=buf15]
#   %arg5_1 : Tensor "f16[64][1]cuda:0" = PlaceHolder[target=arg5_1]
#   %sum_4 : Tensor "f32[1, 1, 126, 126][15904, 15904, 126, 1]cuda:0" = PlaceHolder[target=sum_4]
#   %arg6_1 : Tensor "f16[1, 64, 1, 1][64, 1, 1, 1]cuda:0" = PlaceHolder[target=arg6_1]
#   %view_8 : Tensor "f16[1, 4, 32, 15876][2032128, 508032, 15876, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_1, [1, 4, 32, 15876]), kwargs = {})
#   %view_9 : Tensor "f16[1, 128, 126, 126][2032128, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_8, [1, 128, 126, 126]), kwargs = {})
#   %convolution_1 : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.convolution.default](args = (%view_9, %arg4_1, %arg5_1, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   %convert_element_type_10 : Tensor "f32[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convolution_1, torch.float32), kwargs = {})
#   %pow_3 : Tensor "f32[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_10, 2.0), kwargs = {})
#   %sum_4 : Tensor "f32[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%pow_3, [1], True), kwargs = {})
#   %pow_4 : Tensor "f32[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_4, 0.5), kwargs = {})
#   %convert_element_type_11 : Tensor "f16[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_4, torch.float16), kwargs = {})
#   %clamp_min_1 : Tensor "f16[1, 1, 126, 126][15876, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%convert_element_type_11, 1e-12), kwargs = {})
#   %expand_7 : Tensor "f16[1, 64, 126, 126][15876, 0, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%clamp_min_1, [1, 64, 126, 126]), kwargs = {})
#   %div_3 : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convolution_1, %expand_7), kwargs = {})
#   %mul_3 : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_3, %arg6_1), kwargs = {})
#   %mul_4 : Tensor "f16[1, 64, 126, 126][1016064, 15876, 126, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_3, 8.0), kwargs = {})
#   return %sum_4,%mul_4
...
def triton_per_fused_clamp_min_convolution_div_expand_linalg_vector_norm_mul_view_10(in_ptr0, in_ptr1, in_ptr2, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp17 = tmp15 * tmp16
    tl.store(out_ptr1 + (x0 + 15876*r0_1), tmp17, xmask)
''', device_str='cuda')

def partition_0(args):
    arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1 = args
    args.clear()
    assert_size_stride(arg0_1, (1, 64, 126, 126), (1016064, 15876, 126, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf1 = empty_strided_cuda((1, 64, 126, 126), (1016064, 1, 8064, 64), torch.float16)
        # Topologically Sorted Source Nodes: [normalize, mul, mul_1], Original ATen: [aten.linalg_vector_norm, aten.clamp_min, aten.expand, aten.div, aten.mul]
        # [Provenance debug handles] triton_per_fused_clamp_min_div_expand_linalg_vector_norm_mul_0:1
        stream0 = get_raw_stream(0)
        triton_per_fused_clamp_min_div_expand_linalg_vector_norm_mul_0.run(arg0_1, arg1_1, buf1, 15876, 64, stream=stream0)
        del arg0_1
        del arg1_1
        ...
        assert_size_stride(buf2, (1, 384, 126, 126), (6096384, 1, 48384, 384), 'torch.ops.aten.convolution.default')
        del arg2_1
        del buf1
        buf3 = empty_strided_cuda((1, 4, 32, 1, 125), (16000, 4000, 125, 16000, 1), torch.float32)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
        # [Provenance debug handles] triton_red_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_1:3
        stream0 = get_raw_stream(0)
        triton_red_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_1.run(arg3_1, buf2, buf3, 128, 125, 128, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_2.run(buf3, buf4, 128, 125, stream=stream0)
        buf5 = buf3; del buf3  # reuse
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
        # [Provenance debug handles] triton_red_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_3:5
        stream0 = get_raw_stream(0)
        triton_red_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_3.run(arg3_1, buf2, buf4, buf5, 128, 125, 128, stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused__softmax_cat_expand_prepare_softmax_online_select_split_unsqueeze_view_4.run(buf5, buf6, 128, 125, stream=stream0)
        del buf5
        buf7 = empty_strided_cuda((1, 4, 15880, 32), (2032640, 508160, 32, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, , transpose, contiguous], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, aten.sub, aten.exp, aten.transpose, aten.clone]
        # [Provenance debug handles] triton_poi_fused__softmax_cat_clone_exp_expand_select_split_sub_transpose_unsqueeze_view_5:7
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_cat_clone_exp_expand_select_split_sub_transpose_unsqueeze_view_5.run(arg3_1, buf2, buf4, buf6, buf7, 2032640, stream=stream0)
        del buf4
        del buf6
        buf8 = empty_strided_cuda((1, 4, 15880, 32), (2032640, 508160, 32, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_4, unsqueeze_1, memory_v, v_1, v_2, transpose_2, contiguous_1], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten.transpose, aten.clone]
        # [Provenance debug handles] triton_poi_fused_cat_clone_expand_select_split_transpose_unsqueeze_view_6:8
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_clone_expand_select_split_transpose_unsqueeze_view_6.run(arg3_1, buf2, buf8, 2032640, stream=stream0)
        del arg3_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf7, (4, 32, 15880), (508160, 1, 32), 0), reinterpret_tensor(buf8, (4, 15880, 32), (508160, 32, 1), 0), out=buf9)
        del buf7
        del buf8
        buf10 = empty_strided_cuda((1, 4, 1, 15876), (63504, 1, 63504, 4), torch.float32)
        buf11 = empty_strided_cuda((1, 4, 1, 15876), (63504, 1, 63504, 4), torch.float32)
        # Topologically Sorted Source Nodes: [chunk, q_1, softmax, ], Original ATen: [aten.split, aten.view, aten._softmax, prims.prepare_softmax_online]
        # [Provenance debug handles] triton_per_fused__softmax_prepare_softmax_online_split_view_7:10
        stream0 = get_raw_stream(0)
        triton_per_fused__softmax_prepare_softmax_online_split_view_7.run(buf2, buf10, buf11, 63504, 32, stream=stream0)
        buf12 = empty_strided_cuda((1, 4, 32, 15876), (2032128, 508032, 15876, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, q_1, softmax, , q_2], Original ATen: [aten.split, aten.view, aten._softmax, aten.sub, aten.exp, aten.mul]
        # [Provenance debug handles] triton_poi_fused__softmax_exp_mul_split_sub_view_8:11
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_exp_mul_split_sub_view_8.run(buf2, buf10, buf11, buf12, 15876, 128, stream=stream0)
        del buf10
        del buf11
        del buf2
        buf13 = empty_strided_cuda((4, 32, 15876), (508032, 15876, 1), torch.float16)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf9, (4, 32, 32), (1024, 1, 32), 0), reinterpret_tensor(buf12, (4, 32, 15876), (508032, 15876, 1), 0), out=buf13)
        del buf9
        buf14 = reinterpret_tensor(buf12, (1, 128, 126, 126), (2032128, 1, 16128, 128), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [out, out_1, input_1], Original ATen: [aten.view, aten.convolution]
        # [Provenance debug handles] triton_poi_fused_convolution_view_9:13
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_view_9.run(buf13, buf14, 128, 15876, stream=stream0)
        del buf13
        # Topologically Sorted Source Nodes: [out, out_1, input_1], Original ATen: [aten.view, aten.convolution]
        ...
        assert_size_stride(buf15, (1, 64, 126, 126), (1016064, 1, 8064, 64), 'torch.ops.aten.convolution.default')
        del arg4_1
        del buf14
        buf17 = empty_strided_cuda((1, 64, 126, 126), (1016064, 15876, 126, 1), torch.float16)
        # Topologically Sorted Source Nodes: [out, out_1, input_1, normalize_1, mul_3, input_2], Original ATen: [aten.view, aten.convolution, aten.linalg_vector_norm, aten.clamp_min, aten.expand, aten.div, aten.mul]
        # [Provenance debug handles] triton_per_fused_clamp_min_convolution_div_expand_linalg_vector_norm_mul_view_10:15
        stream0 = get_raw_stream(0)
        triton_per_fused_clamp_min_convolution_div_expand_linalg_vector_norm_mul_view_10.run(buf15, arg5_1, arg6_1, buf17, 15876, 64, stream=stream0)
        del arg5_1
        del arg6_1
        del buf15
    return (buf17, )
...
def get_args():
    ...
    arg0_1 = rand_strided((1, 64, 126, 126), (1016064, 15876, 126, 1), device='cuda:0', dtype=torch.float16)
