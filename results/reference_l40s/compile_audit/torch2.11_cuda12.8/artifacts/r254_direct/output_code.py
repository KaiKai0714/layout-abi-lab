...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/ax/caxkule7nlzfqqolehktjyekgf6zzzf4g5uwd4m4bnvck4cwgz5b.py
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/yz/cyzmvyfexgbiyd5iizgk2a5eswpqlbgsljakcpwtccx54cnhcba4.py
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/yx/cyxfqhs5nidbzbdjsmzl3kczmcakvggwzefru3oh4cgaqnkjc7r7.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/wk/cwko6uisitjwvn3cr7sdigec6djateqf6q5gu6iga2reikq76ic5.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/ef/cef6s5zhsgey6ctq7lobcjbr3mraiiuwaruxdqmyk2ygdtdr3i6a.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/4q/c4qnyfkj5u23eoiu4ikr77uxlyhuxd7bbsmf27cfpittqcdzelfe.py
...
def triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp6 = tmp0 >= tmp3
    tmp7 = tl.full([1, 1], 64520, tl.int64)
    tmp8 = tmp0 < tmp7
    ...
    tl.store(out_ptr0 + (x1 + 64520*y0), tmp17, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r254_direct/inductor/kj/ckjdg5snhscnyjj353yqfjrbr4a65pxzeuhl27hnhvne64y4lscx.py
...
def triton_poi_fused_cat_expand_select_split_unsqueeze_view_6(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp10 = tl.where(tmp4, tmp5, tmp9)
    tl.store(out_ptr0 + (x1 + 64520*y0), tmp10, xmask & ymask)
''', device_str='cuda')


# kernel path: <AUDIT_CACHE>/r254_direct/inductor/2e/c2ec3f7rx44s6fwmyqqeehywti3xzl3nkczdiw6umg4jibljfdrh.py
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/e2/ce2ds356ofo6ux4s5go6zzqqjcku6xev5psgzzdihe6ypk4n3olj.py
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/mk/cmkqysvfmmpc3mkr6wgcijid4ecdavqlvgvw3pnwlm4jxqzkkael.py
...
# kernel path: <AUDIT_CACHE>/r254_direct/inductor/nm/cnmtt5qqwg5mcx2u6f53shsens4qa2fhprbqcuhktpljnlgmrrpk.py
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf5
        buf7 = empty_strided_cuda((1, 4, 32, 64520), (8258560, 2064640, 64520, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, aten.sub, aten.exp]
        # [Provenance debug handles] triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5:7
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_cat_exp_expand_select_split_sub_unsqueeze_view_5.run(arg3_1, buf2, buf4, buf6, buf7, 128, 64520, stream=stream0)
        del buf4
        del buf6
        buf8 = empty_strided_cuda((1, 4, 32, 64520), (8258560, 2064640, 64520, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_4, unsqueeze_1, memory_v, v_1, v_2], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat]
        # [Provenance debug handles] triton_poi_fused_cat_expand_select_split_unsqueeze_view_6:8
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_expand_select_split_unsqueeze_view_6.run(arg3_1, buf2, buf8, 128, 64520, stream=stream0)
        del arg3_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf7, (4, 32, 64520), (2064640, 64520, 1), 0), reinterpret_tensor(buf8, (4, 64520, 32), (2064640, 1, 64520), 0), out=buf9)
        del buf7
        del buf8
