...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/pi/cpiqpxd2c5mcb6ukubehvs4ndszkfate6dmyw33qip7t2jocmppt.py
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/if/cif4vxjzsxzpukszcp35aewbnbcb2d4xmwz5tcdgfgucumhip2h7.py
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/sw/cswgxkr2hejoqs3uya3awy733nafp2m4dmjnt4owuik54ekzch37.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/4a/c4ajf7mqvraiciswen7sr6hf4vjdt5q7ocw7uk3lvaguoqpg2a73.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/zx/czxixoh75ozhtx6ucssnrhgaqx5nd353ru466toyndpyvnvythld.py
# Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, ], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, prims.prepare_softmax_online]
# Source node to ATen node mapping:
#    => prepare_softmax_online_default_1
#   chunk => split
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/4a/c4avqf5cuboydkeyueqbes4ijt3do7jrwenuqi42q5hb5hrp75nm.py
...
#   %permute : Tensor "f16[1, 4, 16133, 32][2065024, 516256, 1, 16133]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_5, [0, 1, 3, 2]), kwargs = {})
#   %clone : Tensor "f16[1, 4, 16133, 32][2065024, 516256, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/jx/cjxz6vukrpefyy5elahkbfgiyqqxiyxqh6ek6ojlorja4rwyquar.py
...
#   %permute_2 : Tensor "f16[1, 4, 16133, 32][2065024, 516256, 1, 16133]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%cat_1, [0, 1, 3, 2]), kwargs = {})
#   %clone_1 : Tensor "f16[1, 4, 16133, 32][2065024, 516256, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_2,), kwargs = {memory_format: torch.contiguous_format})
#   return %expand_4
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/k7/ck73q57to4dluja7t2mpklnztaxhzqcgwr7hokeiq3oevrkwjzf3.py
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/zv/czvfverrhtwqejxqwkyxzkzdofp4cjbx6wciwzlzbvuzscwzr3tg.py
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/ww/cwws3abm574cxz2u6je6beocpzgly4h6njtrnokxcha3u5bho44l.py
...
# kernel path: <AUDIT_CACHE>/r127_repair_kv/inductor/mn/cmnnww6gxmmnpeempwxfvruhu72gu6l2n7pasbyunuie6le2742c.py
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf5
        buf7 = empty_strided_cuda((1, 4, 16133, 32), (2065024, 516256, 32, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_3, unsqueeze, memory_k, k_1, k_2, k_3, , transpose, contiguous], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten._softmax, aten.sub, aten.exp, aten.transpose, aten.clone]
        # [Provenance debug handles] triton_poi_fused__softmax_cat_clone_exp_expand_select_split_sub_transpose_unsqueeze_view_5:7
        stream0 = get_raw_stream(0)
        triton_poi_fused__softmax_cat_clone_exp_expand_select_split_sub_transpose_unsqueeze_view_5.run(arg3_1, buf2, buf4, buf6, buf7, 2065024, stream=stream0)
        del buf4
        del buf6
        buf8 = empty_strided_cuda((1, 4, 16133, 32), (2065024, 516256, 32, 1), torch.float16)
        # Topologically Sorted Source Nodes: [chunk, getitem_4, unsqueeze_1, memory_v, v_1, v_2, transpose_2, contiguous_1], Original ATen: [aten.split, aten.select, aten.unsqueeze, aten.expand, aten.view, aten.cat, aten.transpose, aten.clone]
        # [Provenance debug handles] triton_poi_fused_cat_clone_expand_select_split_transpose_unsqueeze_view_6:8
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_clone_expand_select_split_transpose_unsqueeze_view_6.run(arg3_1, buf2, buf8, 2065024, stream=stream0)
        del arg3_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf7, (4, 32, 16133), (516256, 1, 32), 0), reinterpret_tensor(buf8, (4, 16133, 32), (516256, 32, 1), 0), out=buf9)
        del buf7
        del buf8
